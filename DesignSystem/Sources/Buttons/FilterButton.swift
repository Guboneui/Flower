...
public class FilterButton: UIView {
	...
	private enum ColorSet {
		...
		static let textColor: UIColor = AppTheme.Color.black
		static let ImageColor: UIColor = AppTheme.Color.black
		static let selectedFilterBorderColor: UIColor = AppTheme.Color.primary
		static let filterBorderColor: UIColor = AppTheme.Color.grey70
	}
